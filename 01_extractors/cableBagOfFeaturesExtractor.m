function [features, featureMetrics, varargout] = cableBagOfFeaturesExtractor(I)
...
cropImage = imcrop(grayImage,[110 110 800 800]);
...
features = extractFeatures(img, multiscaleGridPoints,'Upright',true);
